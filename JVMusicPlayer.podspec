#
# Be sure to run `pod lib lint JVMusicPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/JVMusicPlayer.git", :tag => s.version.to_s }
